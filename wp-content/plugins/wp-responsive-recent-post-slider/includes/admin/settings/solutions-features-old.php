	...
	<div class="wppsac-sf-wrap">
		<div class="wppsac-sf-inr">
			...
			<div class="wppsac-sf-features-section wppsac-sf-team wppsac-sf-center">
				...
				<a href="<?php// echo esc_url(WPRPS_PLUGIN_BUNDLE_LINK); ?>"  target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now This Deal</a> -->
			<!-- <h1 class="wppsac-sf-heading">Only <span class="wppsac-sf-blue">November 2022</span> Deal <span class="wppsac-sf-blue">40% OFF</span></h1>
				...
				<a href="<?php //echo esc_url(WPRPS_PLUGIN_BUNDLE_LINK); ?>" target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
				...
				<p style="font-weight: bold !important; font-size:20px !important;"><span style="color: #50c621;">Essential Plugin Bundle</span> + Any Leading Builders (Avada / Elementor / Divi / <br>VC-WPBakery / Site Origin / Beaver) = <span style="background: #50c621;color: #fff;padding: 2px 10px;">WordPress Magic</span></p>
					...
					<a href="<?php echo esc_url(WPRPS_PLUGIN_BUNDLE_LINK); ?>" target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			</div>
			<div class="wppsac-sf-features-section wppsac-sf-team wppsac-sf-center">
				<h1 class="wppsac-sf-heading">Powerful Team Behind <span class="wppsac-sf-blue">Post Slider</span> Including in <span class="wppsac-sf-blue">Essential Plugin Bundle</span></h1>
					...
					<img class="wppsac-sf-image" src="<?php echo esc_url(WPRPS_URL); ?>/assets/images/wpos-team.png" alt="wpos team" />
			</div>
			...
			<div class="wppsac-sf-welcome-wrap">
				<div class="wppsac-sf-welcome-inr wppsac-sf-center">
						...
						<a href="<?php echo esc_url( $wppsac_add_link ); ?>" class="wppsac-sf-btn">Launch Post Slider With Free Features</a> <br /><b>OR</b> <br /> <a href="<?php echo esc_url(WPRPS_PLUGIN_BUNDLE_LINK); ?>"  target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				...
				<div class="wppsac-sf-welcome-wrap wppsac-sf-center">
					<div class="wppsac-features-box-wrap">
						<ul class="wppsac-features-box-grid">
							...
							<!-- <li>
							<div class="wppsac-popup-icon"><img src="<?php //echo esc_url(WPRPS_URL); ?>/assets/images/popup-icon/centermode.png" /></div>
							Center Mode View</li> -->
						</ul>
					</div>
					...
					<div class="wppsac-rc-wrap">
						<div class="wppsac-rc-inr wppsac-rc-bg-box">
							...
							<div class="wppsac-rc-cont">
								<h3>30 Days Refund Policy. 0 risk to you.</h3>
								<p>30-day No Question Asked Refund Guarantee</p>
							</div>
						</div>
						<div class="wppsac-rc-inr wppsac-rc-bg-box">
